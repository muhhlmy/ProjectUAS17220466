...
public class Cashier extends javax.swing.JFrame {
    ...
    private int kodeProduk() {
        ...
        try {
            ...
            String cariKodeHarga = "SELECT Harga FROM db_produk WHERE Kode = ?";
            ...
            if (resultSet.next()) {
                //Jika Kode ditemukan dan sesuai dengan database dalam db_produk maka akan mengambil harga dari kode yang dimasukkan
            ...
            //Melakukan perhitungan untuk Total dalam produk
